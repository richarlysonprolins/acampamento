...
const AccountView = {
  ...
  setup() {
    ...
    const updateUserAvatar = async (filename) => {
      try {
        const response = await fetch('/api/user_profile.php?action=update_avatar', {
          method: 'POST',
          headers: {
    ...
    const updateAccount = async () => {
      try {
        ...
        const response = await fetch('/api/user_profile.php?action=update', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
    ...
    const changePassword = async () => {
      ...
      try {
        ...
        const response = await fetch('/api/user_profile.php?action=change_password', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
    ...
    const saveUnity = async () => {
      ...
      try {
        const url = editingUnity.value
          ? '/api/units.php?action=update'
          : '/api/units.php?action=create'
        const response = await fetch(url, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
...
const MembersView = {
  ...
  setup() {
    ...
    const loadRolesAndUnits = async () => {
      try {
        // Carregar cargos
        const rolesResponse = await fetch('/api/roles.php')
        if (rolesResponse.ok) {
    ...
    const saveMember = async () => {
      ...
      try {
        const url = editingMember.value
          ? '/api/members.php?action=update'
          : '/api/members.php?action=create'
        const response = await fetch(url, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
    ...
    const saveGame = async () => {
      ...
      try {
        const url = editingGame.value
          ? '/api/games.php?action=update'
          : '/api/games.php?action=create'
        const response = await fetch(url, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
